...
server.on("request", async (req, res) => {
    ...
    res.setHeader("Content-Encoding", "gzip"); //Aggiungiamo questo all'headerr per indicare al client che il contenuto che stiamo inviando è compresso con l'algoritmo GZip
